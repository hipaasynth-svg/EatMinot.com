...
var RAW = [
  ["The Starving Rooster", "30 1st St NE, Minot, ND 58701", "Mon-Thu 11am-10pm, Fri-Sat 11am-11pm, Sun 10am-9pm"],
  ["Ebeneezer's Eatery & Irish Pub", "300 E Central Ave, Minot, ND 58701", "Daily 7am-1am (kitchen closes ~10pm)"],
  ["Bone's BBQ Smokehouse & Grill", "437 N Broadway, Minot, ND 58703", "Mon-Thu 11am-10pm, Fri-Sat 11am-11pm, Sun 11am-10pm"],
  ...
  ["Prairie Sky Breads", "3 1st St SE Ste 3, Minot, ND 58701", "Tue 9am-2pm, Wed-Fri 7:30am-4pm, Sat-Sun 9am-4pm, Mon Closed"],
  ["Magic City Hoagies & Sweets", "123 Main St S, Minot, ND 58701", "Verify hours"],
  ["Minot's Daily Bread", "1500 S Broadway, Minot, ND 58701", "Mon-Sat 6:30am-4:30pm, Sun Closed"],
  ["Badlands Restaurant and Bar", "1400 31st Ave SW, Minot, ND 58701", "Mon-Thu 11am-10pm, Fri 11am-11pm, Sat 11am-10pm, Sun 10am-10pm"],
  ...
  ["Ziggy's Caribbean Cuisine", "201 University Ave W, Minot, ND 58703", "Mon-Sat 11am-7pm, Sun Closed"],
  ["China Star", "1631 S Broadway, Minot, ND 58701", "Verify hours"],
  ["JL Beers", "2001 22nd Ave SW, Minot, ND 58701", "Mon-Thu 11am-10pm, Fri-Sat 11am-12am, Sun 11am-10pm"],
  ["Sammy's Pizza", "400 N Broadway, Minot, ND 58703", "Mon-Sat 11am-9pm, Sun 4pm-9pm"],
  ["Planet Pizza", "220 S Broadway, Minot, ND 58701", "Mon-Thu 11am-9pm, Fri-Sat 11am-10pm, Sun 12pm-9pm"],
  ["Nite Train Pizza", "515 20th Ave SE Ste 7, Minot, ND 58701", "Mon-Sat 11am-10pm, Sun 3pm-10pm"],
  ["Uncle Maddio's Pizza Joint", "3310 16th St SW #100, Minot, ND 58701", "Daily 11am-9pm"],
  ...
  ["Off The Vine", "15 Main St S, Minot, ND 58701", "Mon-Thu 3pm-11pm, Fri-Sat 3pm-1am, Sun Closed"],
  ["Souris River Brewing", "32 3rd St NE, Minot, ND 58703", "Verify hours"],
  ["Broadway Bean and Bagel", "1701 S Broadway, Minot, ND 58701", "Mon-Fri 7am-4pm, Sat-Sun 8am-2pm"],
  ["Do Eat", "2400 10th St SW #522 (Dakota Square Mall), Minot, ND 58701", "Mon-Thu 11am-9:30pm, Fri-Sat 11am-10pm, Sun 11am-9:30pm"],
  ...
  ["Joe's Italian Restaurant", "7 1st St SE, Minot, ND 58701", "Sun-Thu 11am-9pm, Fri-Sat 11am-10pm"],
  ["Lucky Bowl", "122 Main St S, Minot, ND 58701", "Verify hours"],
  ["Rocky's Burgers Franks & Fries", "623 N Broadway, Minot, ND 58703", "Daily 10:30am-10pm"],
  ...
  ["N.D. Asia Restaurant & Lounge", "3400 16th St SW, Minot, ND 58701", "Sun-Thu 11am-9:30pm, Fri-Sat 11am-10:30pm"],
  ["Spicy Pie", "1100 N Broadway #100, Minot, ND 58703", "Sun-Tue 11am-9pm, Wed-Sat 11am-10pm"],
  ["Happy Joe's Pizza & Ice Cream", "420 20th Ave SE, Minot, ND 58701", "Mon-Thu 9am-9pm, Fri-Sat 9am-10pm, Sun 9am-9pm"],
  ["Marco's Pizza", "Multiple locations, Minot, ND", "Verify hours"],
  ["The Wurst Case Scenario", "1901 N Broadway Ste B (North Hill Bowl), Minot, ND 58703", "Mon-Thu 11am-10pm, Fri-Sat 11am-11pm, Sun 11am-10pm"]
];
...
/* ---------- placeholder directory data ----------
   Rows in RAW that were never confirmed carry a stand-in rather than real data. These
   two predicates exist so nothing ever writes a stand-in over a real value that someone
   filled in by hand — see api/admin.js refreshInfo, where doing exactly that used to
   wipe every corrected set of hours back to "Verify hours" in one click. */
function isPlaceholderHours(h) {
  h = String(h || '').trim();
  return !h || /verify/i.test(h);
}
function isPlaceholderAddress(a) {
  a = String(a || '').trim();
  if (!a) return true;
  // A bare city, a vague neighbourhood, or "several branches" is not an address.
  return /^minot,?\s*nd\.?$/i.test(a) ||
         /^downtown\s+minot$/i.test(a) ||
         /^multiple locations/i.test(a) ||
         /locations,\s*minot,\s*nd$/i.test(a);
}
...
function checkAdmin(pw) { return safeEqual(pw, process.env.EAT_ADMIN_PASSWORD || ADMIN_DEFAULT); }
...
/* ---------- signed tag tokens ----------
   ...
   under EAT_TAG_SECRET. It is deterministic, so a venue's tag URL never changes
   and a printed tag never goes stale unless the secret is rotated.

   This deliberately uses its own secret rather than EAT_SESSION_SECRET: that one
   ...
   EAT_REQUIRE_TAG_SIG is '1' AND the secret is set. Reprint or reprogram the tags
...
function tagSecret() { return process.env.EAT_TAG_SECRET || ''; }
...
function tagSigEnforced() { return !!tagSecret() && process.env.EAT_REQUIRE_TAG_SIG === '1'; }
...
var memTtl = global.__eatttl || (global.__eatttl = new Map());
...
var COUPON_KEY = function (c) { return 'eatminot:coupon:' + c; };
var COUPON_DEV_KEY = function (t) { return 'eatminot:couponsof:' + t; };
...
function newCouponCode() { return 'EAT' + randomCode(COUPON_CODE_LEN); }
...
async function redeemCoupon(code, note) {
  ...
  var won = await claimOnce('eatminot:redeeming:' + code, 60);
...
async function scanCoupons() {
  ...
  if (!hasKV()) {
    mem.forEach(function (v, k) {
      if (k.indexOf('eatminot:coupon:') !== 0) return;
  ...
  do {
    var r = await kvCmd(['SCAN', cursor, 'MATCH', 'eatminot:coupon:*', 'COUNT', '500']);
...
module.exports = {
  ...
  scanCoupons: scanCoupons,
  couponCodeFormat: couponCodeFormat,
  // staff PIN
