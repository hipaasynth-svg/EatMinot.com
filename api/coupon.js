...
module.exports = async function (req, res) {
  ...
  try {
    ...
    if (b.action === 'walletLink') {
      ...
      var wr = await W.googleSaveOffer(dev2, wc.code, wp ? wp.name : 'EatMinot', wc.reward, wc.expiresAt);
    ...
    if (b.action === 'peek') {
      ...
      var peekLim = await L.rateLimit('eatminot:rl:peek:' + ip, 120, 900);
    ...
    if (b.action === 'redeem') {
      ...
      var cKey = 'eatminot:pinfail:c:' + code;
      var vKey = 'eatminot:pinfail:v:' + profile.id;
      var iKey = 'eatminot:pinfail:ip:' + ip;
