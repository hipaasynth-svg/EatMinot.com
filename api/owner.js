...
module.exports = async function (req, res) {
  ...
  try {
    ...
    // First-run claim: an unclaimed listing can be opened once with no password (the owner's
    // ?owner=<id> QR). Setting a password claims it; after that this path is closed and the
    // owner must log in. One-time by construction — the claimed flag gates it.
    if (b.action === 'claim') {
